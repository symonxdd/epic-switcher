...
export const Footer = () => {
  ...
  return (
    <footer id="contact" className="py-12 border-t">
      <div className="container mx-auto px-6"><div className="mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground/60">
